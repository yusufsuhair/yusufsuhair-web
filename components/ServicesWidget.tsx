...
const services: Service[] = [
  {
    ...
    description: "Weekly live workshops teaching AI-assisted development and automation — founding member access, limited spots. More detail at ysacademy.my.",
  ...
  },
  {
    ...
    renderIcon: () => (
      <div className="flex items-center gap-2">
        <SiAppstore size={24} className="text-[#1c1a16]" />
        ...
        >
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-xs text-[#8a8371] mt-2" style={mono}>
              Fullstack &amp; DevSecOps Engineer · Hermes AI Consultant
            </p>
            <p className="text-[#4a463d] text-sm md:text-base mt-4 max-w-[500px] leading-relaxed">
              6+ years building secure, scalable systems — from AI platforms to Web3 and 50+
              shipped mobile apps. Founder of YS Academy, now helping business owners set up
              Hermes AI agents and ship the digital products their business needs.
            </p>
